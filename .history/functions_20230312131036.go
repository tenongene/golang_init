...
//DEFER STATEMENT - delays execution until surrounding functin returns
func listName(name string) string{
	retifmt.Println(name)
}
func listAge(age int) int {
	return fmt.Println(age)
}
func listHobby(hobby string) string{
	return fmt.Println(hobby)
}
