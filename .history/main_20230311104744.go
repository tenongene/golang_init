...
func main() {
	...
	//getting type of variable - use "reflect.TypeOf" method (can also use %T in non-string formatting)

	fmt.Printf("%v is a type of %v", a, reflect.TypeOf(a))
	fmt.PrintLn(a, " is a type of %T", a)
