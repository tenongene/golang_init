...
func main() {
	...
	//getting type of variable - use "reflect.TypeOf" method (can also use %T)

	// fmt.Printf("%v is a type of %v \n", a, reflect.TypeOf(a))
	// fmt.Printf("%v is a type of %T", a, a)

	//Type conversion/casting
	// from variable i above
	// var f float64 = float64(i);
	// fmt.Printf("%.2f\n", f)

	// //integer to string using "strconv" package (import)
	// var num string = strconv.Itoa(i)
	// fmt.Printf("%q \n", num)

	// //String to integer using "strconv" package (import) - also returns error if any
	// var digit string = "13"
	// newDigit, err := strconv.Atoi(digit)
  // fmt.Printf("%d %v \n", newDigit, err)

	//constants  - must always be declared and assigned - constants have no zero/nullish value, no shorthand
	// const name = "Harry"
}
